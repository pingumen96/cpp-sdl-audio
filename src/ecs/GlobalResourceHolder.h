...
namespace ecs {
    ...
    /**
     * @brief Simple holder for global ECS resources
     *
     * This is different from the resources::ResourceSystem which manages file-based resources.
     * This manages runtime global state objects like InputState, EventBus, etc.
     */
    class GlobalResourceHolder {
    private:
        std::unordered_map<std::type_index, std::shared_ptr<void>> mResources;

    public:
        GlobalResourceHolder() = default;
        ~GlobalResourceHolder() = default;

        // Non-copyable, non-movable
        GlobalResourceHolder(const GlobalResourceHolder&) = delete;
        GlobalResourceHolder& operator=(const GlobalResourceHolder&) = delete;
        GlobalResourceHolder(GlobalResourceHolder&&) = delete;
        GlobalResourceHolder& operator=(GlobalResourceHolder&&) = delete;
        ...
        T& getResource() {
            ...
            if (it == mResources.end()) {
                throw std::runtime_error("Global resource not found");
            }
        ...
        /**
         * @brief Clear all global resources
         */
        void clear() {
            mResources.clear();
        }
