...
namespace scene {
    ...
    public:
        ...
        void renderOverlay(RenderQueueBuilder& builder) override {
            if (fadeAlpha > 0.0f) {
                ...
                UIItem fadeQuad;
                fadeQuad.position = math::Vec2f(0.0f, 0.0f);
                fadeQuad.size = math::Vec2f(1.0f, 1.0f); // Full screen
                fadeQuad.textureId = ""; // Solid color
                fadeQuad.color = math::Vec4f(0.0f, 0.0f, 0.0f, fadeAlpha);
    ...
    public:
        ...
        void renderOverlay(RenderQueueBuilder& builder) override {
            ...
            background.color = math::Vec4f(0.1f, 0.1f, 0.1f, 0.9f);
            ...
            progressFill.size = math::Vec2f(0.5f * progress, 0.05f);
            ...
            UIItem loadingText;
            loadingText.position = math::Vec2f(0.4f, 0.3f);
            loadingText.size = math::Vec2f(0.2f, 0.1f);
            loadingText.textureId = "loading_text";
            loadingText.color = math::Vec4f(1.0f, 1.0f, 1.0f, 1.0f);
    ...
    public:
        ...
        void renderOverlay(RenderQueueBuilder& builder) override {
            ...
            if (progress > 0.0f && progress < 1.0f) {
                UIItem overlay;
                overlay.position = math::Vec2f(0.0f, 0.0f);
                overlay.size = math::Vec2f(1.0f, 1.0f);
                overlay.textureId = "";
                overlay.color = math::Vec4f(1.0f, 1.0f, 1.0f, 0.5f * (1.0f - progress));
                overlay.layer = 998;
